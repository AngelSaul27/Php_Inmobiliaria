    ...
    <div class="h-screen bg-gray-100 flex items-center">
        <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
            <div class="max-w-md">
                ...
                <a href="/" class="px-4 block w-max py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-amber bg-amber-600 active:bg-blue-600 hover:bg-amber-700">
                    Regresar
                </a>
            </div>
            <div class="max-w-lg">
