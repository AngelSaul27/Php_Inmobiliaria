            ...
            <table class="w-full p-6 text-sm text-left">
                ...
                <thead class="bg-gray-700 whitespace-nowrap">
                    <tr class="text-left">
                        ...
                        <th class="p-3 text-center">Publicación</th>
                        <th class="p-3"></th>
                    </tr>
                </thead>
                <tbody class="border-b bg-[#101820] border-gray-700">
                    <?php foreach ($this->items as $item) : $fechaActual = date('Y-m-d'); ?>
                        <tr>
                            ...
                            <td class="p-3">
                                <p class="w-max"><?php echo $item[6] ?></p>
                            </td>
                            <td class="p-3">
                                <p class="w-max"><?php echo $item[8] ?></p>
                            </td>
                            <td class="p-3">
                                <p class="w-max"><?php echo number_format($item[9]) ?></p>
                            </td>
                            <td class="p-3 text-center">
                                <p class="w-max"><?php echo $item[16] ?></p>
                            </td>
                            <td>
                                <form action="<?php echo URL ?>deleted_cita_admin" method="POST">
                                    <input type="text" name="cit_id" value="<?php echo $item[0] ?>" class="hidden">
                                    <input type="text" name="cit_loc" value="acesor/citas" class="hidden">
